...
volatile u8           statePre[TANK_LIST_MAX][TANK_WARN_ITEM_MAX];
        ...
        if(VALUE_NULL != value)
        {
            if(smog_Pre != value)
            {
                ...
                if(0x01 == value)
                {
                    ...
                    sendWarnReport(WARN_SMOKE - 1, 1, 0, NO, " ");
                }
                else
                {
        ...
        if(VALUE_NULL != value)
        {
            if(leakage_Pre != value)
            {
                ...
                if(0x01 == value)
                {
                    ...
                    sendWarnReport(WARN_WATER - 1, 1, 0, NO, " ");
                }
                else
                {
...
//        CtrlAllDeviceByFunc(monitor, F_COOL_HEAT, ON, 0);
    ...
    else if(tempNow <= (coolTarge - tempSet.tempDeadband))
    {
        ...
        CtrlAllDeviceByFunc(monitor, F_COOL_HEAT, OFF, 0);
        if(ON == lock)
        {
            if(humiNow >= dehumiTarget)
            {
