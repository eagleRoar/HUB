...
static char mqtt_thread_stack[1024 * /*3*/2];
...
** Descriptions:        mqtt url��ַ����
** input parameters:    c:    mqtt�ͻ��˽ṹʵ���������Ѿ���ֵ��url��ַ
** output parameters:   res�� ����IP��ַ�Ͷ˿ںŴ��
...
** Descriptions:        ��tls���ܴ��䣬������ܴ������Դ
** input parameters:    c:    mqtt�ͻ��˽ṹʵ��
...
**                      length�� �������ݳ���
** output parameters:   NONE
** Returned value:      PAHO_FAILURE: ����ʧ�ܣ�������һЩ�쳣����Ҫ�ر�����
**                      PAHO_SUCCESS�� ���ͳɹ�
*********************************************************************************************************/
...
** Descriptions:        ��ȡ������mqtt֡�еĳ����ֶ�
** input parameters:    c:        mqtt�ͻ��˽ṹʵ��
**                      timeout�� ��ȡ��ʱʱ�䣬�Ժ���Ϊ��λ
** output parameters:   value�� ��ȡ���ȴ�ŵ�ַ
** Returned value:      ��ȡ����
*********************************************************************************************************/
...
** Descriptions:        ��ȡ��һ����Ч�����ݰ�ID
** input parameters:    c:        mqtt�ͻ��˽ṹʵ��
** output parameters:   NULL
** Returned value:      ��ȡ�������ݰ�ID
*********************************************************************************************************/
...
** input parameters:    c:        mqtt�ͻ��˽ṹʵ��
** output parameters:   NULL
** Returned value:      ���ӽ����-1���Ѿ����ӻ�����ʧ�ܣ�0�����ӳɹ�
*********************************************************************************************************/
...
** Descriptions:        У�������Ƿ�ƥ��
** input parameters:    topicFilter:  ƥ��Ŀ������
**                      topic_name��   ƥ��Դ����
** output parameters:   NULL
** Returned value:      ƥ������0��ƥ��ʧ�ܣ�1��ƥ��ɹ�
**   ͨ���˵����
**   #can only be at end
...
** Descriptions:        ��ʼ��mqtt
** input parameters:    c:           mqtt�ͻ��˽ṹʵ��
**                      stack_size�� mqtt�����߳�ջ��С
**                      priority��   mqtt�����߳����ȼ�
** output parameters:   NULL
** Returned value:      ��ʼ�������PAHO_SUCCESS���ɹ��� ������ʧ��
*********************************************************************************************************/
int paho_mqtt_start(mqtt_client *client, rt_uint8_t  priority)
{
...
//  rt_thread_t tid;
  ...
  if(RT_EOK == rt_thread_init(&mqtt_thread, thread_name, paho_mqtt_thread, (void *) client,
                 mqtt_thread_stack, sizeof(mqtt_thread_stack), priority, 10))
  {
...
** Descriptions:        ��ָֹ����mqttӦ��
** input parameters:    c:           mqtt�ͻ��˽ṹʵ��
** output parameters:   NULL
** Returned value:      PAHO_SUCCESS���ɹ��� ������ʧ��
*********************************************************************************************************/
...
** Descriptions:        mqtt��Ϣ����
** input parameters:    client:      mqtt�ͻ��˽ṹʵ��
**                      qos��        ��·����
**                      topic:       ��������
**                      callback:    ƥ�������Ļص�����
** output parameters:   NULL
...
** Descriptions:        �ж�����mqtt�������Ƿ�ɹ�
** input parameters:    client:      mqtt�ͻ��˽ṹʵ��
** output parameters:   NULL
** Returned value:      1: ���ӳɹ���0��δ����
*********************************************************************************************************/
...
**                      arg��     ���õ�ֵָ��
** output parameters:   NULL
** Returned value:      ���ý����PAHO_SUCCESS���ɹ���������ʧ��
*********************************************************************************************************/
